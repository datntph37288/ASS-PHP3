        ...
        <div class="dropdown ms-sm-3 header-item topbar-user">
            ...
            <div class="dropdown-menu dropdown-menu-end">
                ...
                <form action="{{ route('logout') }}" method="POST">
                    @csrf
                    <a class="dropdown-item" ><button type="submit" class="btn btn-primary">
                        <i class="mdi mdi-logout text-muted fs-16 align-middle me-1"></i> <span class="align-middle" data-key="t-logout">Logout</span></button></a>
                </form>
            </div>
        </div>
    </div>
